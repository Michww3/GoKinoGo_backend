...
public interface IUserService
{
    ...
    Task<UserDto> UpdateUserAsync(int userId, UpdateUserDataDto dto, CurrentUserDto currentUser);
    Task UpdatePasswordAsync(int userId, UpdateUserPasswordDto dto, CurrentUserDto currentUser);
