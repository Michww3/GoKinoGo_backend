...
namespace GoKinoGo.Migrations
{
    ...
    [Migration("20260926032423_AddCreatedAtToEmailToken")]
    partial class AddCreatedAtToEmailToken
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoKinoGo.Entities.EmailVerificationToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GoKinoGo.Entities.MovieRating", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("MovieRating", t =>
                        {
                            t.HasCheckConstraint("CK_MovieRating_Value", "[Value] >= 1 AND [Value] <= 10");
                        });
                });
